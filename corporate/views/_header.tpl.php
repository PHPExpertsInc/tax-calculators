...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Federal Corporate Income Tax Calculator | PHP University</title>
...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
			<h1><a href="/">PHP University <div id="slogan">Learn, code, grow</div></a></h1>
		</div>
		<div id="socialbox">
	...
	<div id="pageHeader" class="container">
        <h2>Federal Corporate Income Tax Calculator</h2>
	</div>
</div>
<div id="page-wrapper">
